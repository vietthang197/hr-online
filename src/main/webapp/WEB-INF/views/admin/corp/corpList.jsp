...
<%--                                            <label for="s_name">Tên công ty</label>--%>
    ...
    $(document).ready(function () {
        ...
        const dataTable = $('#dataTable').DataTable({
            ...
            "columns": [
                ...
                {"data": "taxId", "render": $.fn.dataTable.render.text()},
                ...
                {"data": "industries", "render": $.fn.dataTable.render.text()},
            ],
            ajax: {
                url: "/admin/corp/search",
                method: "POST",
                ...
                dataFilter: function (response) {
                    ...
                    for (let i = 0; i < responseJson.data.length; i++) {
                        dataRes.data.push({
                            ...
                            <% if (oauth2Security.hasResourcePermission(request, "Admin Resource", "urn:servlet-authz:protected:admin:access")) { %>
                            "edit": '<a href="/admin/corp/edit/' + responseJson.data[i].id  +'" role="button" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>',
                            <%}%>
                            "name": responseJson.data[i].name,
                            "taxId": responseJson.data[i].taxId,
                            "phone": responseJson.data[i].phone,
                            "address": responseJson.data[i].address,
                            "description": responseJson.data[i].description,
                            "industries": responseJson.data[i].industries
                        })
                    }
