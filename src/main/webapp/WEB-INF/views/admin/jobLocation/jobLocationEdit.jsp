                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name"  name="name" placeholder="Công ty A..." value="<%=(String) request.getAttribute("jobLocationName")%>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="id" name="id" value="<%=(String)request.getAttribute("jobLocationId")%>" required>
                            </div>
                        </div>
                    </div>
